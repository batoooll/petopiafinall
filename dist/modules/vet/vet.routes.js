...
router.post('/profile/photo', auth_middleware_1.protect, (0, auth_middleware_1.restrictTo)('VET'), upload_middleware_1.uploadVet.single('photo'), vetController.uploadProfilePhoto);
// ── Admin Verification ──────────────────────────────────────────
...
router.patch('/appointments/:id/complete', auth_middleware_1.protect, (0, auth_middleware_1.restrictTo)('VET'), vetController.completeAppointment);
