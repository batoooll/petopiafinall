...
router.post("/verification/id-card", auth_middleware_1.protect, imageUpload.single("photo"), sitting_controller_1.SittingController.uploadIdCardPhoto);
// POST /sitting/verification/location - Upload location photo
router.post("/verification/location", auth_middleware_1.protect, imageUpload.single("photo"), sitting_controller_1.SittingController.uploadLocationPhoto);
// GET /sitting/verification/photos - Get verification photos
router.get("/verification/photos", auth_middleware_1.protect, sitting_controller_1.SittingController.getVerificationPhotos);
// ─────────────────────────────────────────────────────────────────────────────
// Availability Routes
// ─────────────────────────────────────────────────────────────────────────────
