...
class SittingRepository {
    ...
    static async countOverlappingAcceptedBookings(sitterProfileId, startDate, endDate) {
        return prisma_1.default.sittingBooking.count({
            where: {
                sitterProfileId,
    ...
    static async searchSitters(filters) {
        ...
        const [sitters, total] = await Promise.all([
            ...
            prisma_1.default.sitterProfile.count({ where: whereClause }),
        ]);
